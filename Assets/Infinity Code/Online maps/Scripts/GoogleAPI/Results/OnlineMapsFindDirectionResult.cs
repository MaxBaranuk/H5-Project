...
/// </summary>
public class OnlineMapsFindDirectionResult
{
    /// <summary>
    ...
    public class Leg
    {
        ...
        public Leg(OnlineMapsXML node)
        {
            ...
            foreach (OnlineMapsXML n in node)
            {
                ...
                else if (n.name == "start_location") start_location = OnlineMapsFindDirection.GetVector2FromNode(n);
                else if (n.name == "end_location") end_location = OnlineMapsFindDirection.GetVector2FromNode(n);
    ...
    public class NameLocation
    {
        ...
        public NameLocation(OnlineMapsXML node)
        {
            foreach (OnlineMapsXML n in node)
            {
                if (n.name == "location") location = OnlineMapsFindDirection.GetVector2FromNode(n);
    ...
    public class Route
    {
        ...
        public Route(OnlineMapsXML node)
        {
            ...
            foreach (OnlineMapsXML n in node)
            {
                ...
                else if (n.name == "overview_polyline") overview_polyline = OnlineMapsFindDirection.DecodePolylinePoints(n["points"].Value()).ToArray();
    ...
    public class Step
    {
        ...
        public Step(OnlineMapsXML node)
        {
            ...
            foreach (OnlineMapsXML n in node)
            {
                ...
                else if (n.name == "polyline") polyline = OnlineMapsFindDirection.DecodePolylinePoints(n["points"].Value()).ToArray();
                else if (n.name == "duration") duration = new TextValue<int>(n);
                else if (n.name == "distance") distance = new TextValue<int>(n);
